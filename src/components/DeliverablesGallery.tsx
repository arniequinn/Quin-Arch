  ...
  return (
    <section id="deliverables" className="py-16 bg-neutral-950 border-t border-neutral-900 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filter Tabs — plain underlined tabs, matching the gallery section below */}
        <div className="flex items-center gap-1 overflow-x-auto pb-3 mb-8 no-scrollbar">
          {categories.map((cat) => (
            <button
              key={cat}
              onClick={() => setActiveCategory(cat)}
              className={`px-3 py-2 text-xs font-medium tracking-wide whitespace-nowrap transition-colors cursor-pointer border-b-2 ${
                activeCategory === cat
