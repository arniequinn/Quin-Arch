      ...
      <div className="relative w-full max-w-2xl rounded-2xl bg-neutral-900 border border-neutral-800 shadow-2xl p-6 sm:p-8 text-neutral-100 max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center space-x-2">
            <span className="text-label font-mono font-semibold uppercase tracking-wider text-amber-400 flex items-center gap-1.5">
              {isAuthorized ? (
                <>
        ...
        {!isAuthorized && (
          <div className="space-y-6">
            <div className="p-4 rounded-xl bg-amber-950/30 border border-amber-500/30 space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-label text-neutral-300 leading-relaxed">
              ...
              <div className="pt-2 border-t border-amber-500/20">
                <div className="p-3 rounded-lg bg-neutral-900 border border-neutral-800 space-y-2 max-w-sm">
                  <div className="text-label font-mono text-neutral-400 uppercase font-semibold">
                  ...
                  <form onSubmit={handleVerifyPasskey} className="space-y-2">
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-1.5 rounded-lg bg-neutral-950 border border-neutral-700 text-label text-neutral-100 focus:outline-none focus:border-amber-500"
                      />
                      <KeyRound className="w-3.5 h-3.5 text-neutral-500 absolute right-2.5 top-2.5" />
                    </div>
                    {passkeyError && (
                      <p className="text-label text-red-400 flex items-center gap-1">
                    ...
                    <button
                      ...
                      className="w-full py-1.5 px-3 rounded-lg bg-neutral-800 hover:bg-neutral-700 disabled:opacity-50 text-neutral-200 text-label font-medium transition-colors"
                    >
                      Unlock Editing Mode
                    </button>
                  </form>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between text-label font-mono text-neutral-400">
              ...
              <div className="p-4 rounded-xl bg-neutral-950 border border-neutral-800 space-y-4 text-label">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <span className="text-neutral-500 text-label block">Architect / Specialist</span>
                    <span className="font-semibold text-neutral-200 text-sm">{currentProfile.name}</span>
                    <span className="text-amber-400 text-label block">{currentProfile.title}</span>
                  </div>
                  <div>
                    <span className="text-neutral-500 text-label block">Brand & Firm</span>
                    <span className="font-semibold text-neutral-200">{currentProfile.brandName || "Quintessential Architecture"}</span>
                    <span className="text-neutral-400 text-label block">{currentProfile.education}</span>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2 border-t border-neutral-900 text-label">
                  <div>
                ...
                <div className="pt-2 border-t border-neutral-900">
                  <span className="text-neutral-500 text-label block mb-1">Executive Summary</span>
                  <p className="text-neutral-300 leading-relaxed text-label">
                    {currentProfile.bio}
                  </p>
                </div>
                ...
                <div className="pt-2 border-t border-neutral-900 flex flex-wrap items-center gap-2">
                  <span className="text-neutral-500 text-label block mr-1">Public Profiles:</span>
                  <a
                    href={currentProfile.socials?.linkedin || "https://www.linkedin.com/in/arslan-qaiser-947976188/"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-sky-950/60 border border-sky-600/40 text-sky-300 text-label hover:text-sky-200 transition-colors"
                  >
                  ...
                  {currentProfile.socials?.upwork && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-1 px-2.5 py-1 rounded-lg bg-neutral-900 border border-neutral-800 text-emerald-400 text-label hover:text-emerald-300 transition-colors"
                    >
                      <span>Upwork</span>
                      <ExternalLink className="w-2.5 h-2.5 ml-0.5 opacity-70" />
                    </a>
              ...
              <div className="pt-2 flex justify-end">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-5 py-2 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-neutral-200 text-label font-medium transition-colors"
                >
                  Close
                </button>
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="p-3 rounded-xl bg-emerald-950/40 border border-emerald-500/40 flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-label text-emerald-200 font-medium">
              ...
              <button
                ...
                className="text-label text-neutral-400 hover:text-neutral-200 underline font-mono cursor-pointer"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-label font-semibold text-neutral-300 mb-1">
            ...
            <div className="p-4 rounded-xl bg-neutral-950 border border-neutral-800 space-y-3">
              <h4 className="text-label font-bold uppercase tracking-wider text-amber-400 font-mono">
                Online Profiles & Freelance Portals
              </h4>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-label">
                <div className="sm:col-span-2">
                  <label className="block text-sky-400 font-mono mb-1 text-label font-semibold flex items-center space-x-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-1.5 rounded-lg bg-neutral-900 border border-sky-800/60 text-neutral-200 text-label focus:outline-none focus:border-sky-500"
                  />
                </div>

                <div>
                  <label className="block text-neutral-400 font-mono mb-1 text-label">Instagram Profile</label>
                  <input
                    type="text"
                    ...
                    className="w-full px-3 py-1.5 rounded-lg bg-neutral-900 border border-neutral-700 text-neutral-200 text-label focus:outline-none focus:border-amber-500"
                  />
                </div>

                <div>
                  <label className="block text-neutral-400 font-mono mb-1 text-label">YouTube Channel URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-neutral-400 font-mono mb-1 text-label">Instagram Handle</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-neutral-400 font-mono mb-1 text-label">Upwork Profile URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-neutral-400 font-mono mb-1 text-label">Fiverr Profile / Gig URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-neutral-400 font-mono mb-1 text-label">Freelancer.com URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-neutral-400 font-mono mb-1 text-label">Cad Crowd Profile URL</label>
                  <input
                    type="text"
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2 rounded-xl bg-neutral-950 border border-neutral-700 text-label text-neutral-100 focus:outline-none focus:border-amber-500 leading-relaxed"
              />
            </div>
            ...
            <div className="pt-3 flex items-center justify-end space-x-3">
              <button
                type="button"
                onClick={onClose}
                className="px-4 py-2.5 rounded-xl bg-neutral-800 hover:bg-neutral-700 text-neutral-300 text-label font-semibold transition-colors"
              >
                Cancel
              </button>
              ...
              <button
                type="submit"
                className="px-5 py-2.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-neutral-950 font-bold text-label flex items-center space-x-2 shadow-md shadow-amber-500/20 transition-all cursor-pointer"
              >
                {savedSuccess ? (
                  <>
